...
<body>
	...
	<div id="cont">	
		...
		<div id="container">
			...
			<p id="z">Instructor: <span id="zz">${instructor.firstName} ${instructor.lastName}</span></p>
			
			<p class="z1">Youtube Channel: <span class="zz2">${instructorDetails.youtubeChannel}</span></p>

			<p class="z1">Hobby: <span class="zz2">${instructorDetails.hobby}</span></p>
